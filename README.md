...
## Jeremy Notes
You're going to have to add the token for ngrok. Make an account at the website.
```
ngrok authtoken <YOUR TOKEN>
```
Starting is weird now. Do `npm start` followed by `npm run expose` in a different folder. 
Use the https link that ngrok exposes.